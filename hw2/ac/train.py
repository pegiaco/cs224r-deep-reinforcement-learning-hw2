...
class Workspace:
    ...
    def setup(self):
        ...
        # create envs
        self.train_env = mw.make(self.cfg.frame_stack)
        self.eval_env = mw.make(self.cfg.frame_stack)
        ...
        copy_tree(str(Path.cwd().parent.parent / "demos/"), str(self.work_dir / 'buffer'))
    ...
    def train(self):
        ...
        for pretrain_step in range(1000):
            metrics = self.agent.pretrain(self.replay_iter)
